...
psd <- function(x, protein, replicate) {
    ...
    # ker merimo 1.001 ns, lahko pretvorimo frekvence iz Hz v ns
    # 999000999 / s = 999000999 / 1e+9 ns = 0.999001 ns^-1
    freq_ns <- freq / 1e+9
    ...
    dfp <- data.frame(frequency = freq_ns[-1], pwr = power[-1]) # BREZ DC KOMPONENTE
